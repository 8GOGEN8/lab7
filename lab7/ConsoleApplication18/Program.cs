...
namespace Лаба_7
{
 ...
 {
 new Employee(1,"Лычагин",1),
 new Employee(2,"Горбунов",2),
 new Employee(3,"Анцифров",2),
 new Employee(4,"Гудилин",3),
 new Employee(5,"Звонарев",2),
 new Employee(6,"Деньгин",1),
 new Employee(7,"Малышева",1),
 new Employee(8,"Деньгин",3),
 new Employee(9,"Пасека",2)
 };
        static List<Department> departments = new List<Department>()
 {
 new Department(1, "Отдел закупок"),
